    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-md max-w-[calc(100vw-2rem)]">
        ...
        <DialogHeader>
          ...
          {/* DialogDescription — это <p>, поэтому вложенные блоки идут рядом, а не внутрь */}
          ...
          <div className="flex items-center gap-2 pt-2 flex-wrap text-sm">
            <Mail className="h-4 w-4 text-muted-foreground flex-shrink-0" aria-hidden />
            <a
